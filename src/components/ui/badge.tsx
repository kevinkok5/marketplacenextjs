...
const badgeVariants = cva(
    "inline-flex items-center rounded-full border border-neutral-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:bg-input focus:ring-offset-2 dark:border-neutral-800 dark:focus:bg-input",
    {
        variants: {
            variant: {
                default:
